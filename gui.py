...
btn_t_e = PhotoImage(file="assets/btn_t_e.png")
btn_t_l = PhotoImage(file="assets/btn_t_l.png")
...
main = Frame(root,bg='white', height=500, width=350)
main.place (x=325, y=50)
...
l = Label(main, text="Training")
l.config(font=("Forte", 16), bg='white')
l.place(x=140, y= 170)

trainE_btn = Button(main, image=btn_t_e, borderwidth=0, bg="white", command=train_eigen_btn_load)
trainE_btn.place(x=50, y = 210)

recogL_btn = Button(main,image=btn_t_l, borderwidth=0, bg="white", command=train_lbph_btn_load)
recogL_btn.place(x=200, y = 210)
